exports.alterIcon = (spanElemId, inputElemId) => {
	const toggleConfirmPassword = document.querySelector(spanElemId);

	const confirmPassword = document.querySelector(inputElemId);
